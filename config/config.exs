...
config :fut_stats, :phoenix_swagger,
  swagger_files: %{
    "priv/static/swagger.json" => [
      router: FutStatsWeb.Router,     # phoenix routes will be converted to swagger paths
      endpoint: FutStatsWeb.Endpoint  # (optional) endpoint config used to set host, port and https schemes.
    ]
  }
